...
*It is not recommended to commit your test with this annotation. Indeed, the displaying of SQL statements would pollute the logs of your continuous integration build and it may slow down your continuous integration build.*
