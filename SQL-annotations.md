...
* Too many returned SQL columns by using [@DisableExactlySameSqlSelects](#DisableExactlySameSqlSelects) 
* Bad use of Hibernate session by using [@DisableExactlySameSqlSelects](#DisableExactlySameSqlSelects)
* Cross join generated by Criteria API by using [@MaxReturnedSqlColumns](#MaxReturnedSqlColumns)
* ...
