...
* Too many returned SQL columns by using [@MaxOfColumnsForEachSelect](#MaxOfColumnsForEachSelect)
* Bad use of Hibernate session by using [@DisableExactlySameSqlSelects](#DisableExactlySameSqlSelects)
* Cross join generated by Criteria API by using [@DisableSqlCrossJoin](#DisableSqlCrossJoin)
* ...
