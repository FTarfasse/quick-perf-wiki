...
Easily [**detect N+1 select**](https://github.com/quick-perf/doc/wiki/Easily-detect-and-fix-plus-one-selects-with-QuickPerf), JDBC batching disabled and other things.
